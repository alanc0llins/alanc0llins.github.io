...
<body>
  ...
  <div class="p-titulo">
    <p class="titulo text-center"><i class="fa fa-user fa-fw"></i>entrar</p>
  </div>
  <div class="container pagina">
  	<ul class="nav nav-pills nav-justified">
  	  <li role="presentation" class="active"><a href="#">Entrar</a></li>
  	  <li role="presentation"><a href="./cadastrar.php">Cadastar</a></li>
  	</ul>
  </div>
  <div class="container pagina">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="col-md-1">
          <button type="button" class="btn btn-default btn-lg bottom w-button wp-button">
            <span class="glyphicon glyphicon-ok wp-button" aria-hidden="true"></span> Entrar
          </button>
      </div>
